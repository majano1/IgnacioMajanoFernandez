...
public class Principal {
	...
	public static void main(String[] args) {
		...
		System.out.println("***Tiradas aleatorias***");
		Scanner teclado=new Scanner(System.in);
		do {
		System.out.println("Introduce el número de tiradas aleatorias: ");
		int introducirtiradas=teclado.nextInt();
		
		System.out.println();
		
		Dado testDado=new Dado();
		
		testDado.realizarTest(introducirtiradas);
		System.out.println("Otro intento? [s/n]");
		otrointento=teclado.next();
		}while(otrointento.equalsIgnoreCase("s"));
